...
if [ "$#" -eq 2 ]; then
    ...
    echo "USAGE: placeCall [auth] ipFile extension"
...
# echo "SESSION is ${session}"
 ...
 curl -H "Authorization: LSBasic ${b64auth}" -H "Content-Type: application/json" --data "{\"params\":{\"number\":${extension}},\"call\":\"Conf_dialNumber\"}" http://${ip}/rest/request/${session} 
